        ...
        <div className="page2Container positionRelative">
            ...
            <div className='page2Block'>
                <div className='MasteryAverageContainer'>
                    ...
                    <input
                        className='btnPlain MasteryAverageTextBox'
                        type="text"
                        value={`${keysetInfo.orderByScore.length === 0 ? '---' : (100 - keysetInfo.masteryLvl + '%')}`}
                        readOnly
                    />
                </div>
            </div>
            ...
            <div className="page2Block">
                    ...
                    <input className='btnPlain MasteryAverageTextBox'
                        type="text"
                        value={`${keysetInfo.avgAccuracy===0?'---':keysetInfo.avgAccuracy + '%'}`}
                        readOnly
                    />
                </div>
                ...
                <div className='MasteryAverageContainer'>
                    ...
                    <input className='btnPlain MasteryAverageTextBox'
                        type="text"
                        value={`${keysetInfo.avgTime===0?'---':keysetInfo.avgTime + 's'}`}
                        readOnly
                    />
                </div>
            </div>
