            ...
            <div className="aboutPageContainer">
                ...
                <div className="aboutPageContent">
                    <BoxSection title={"What Is Note Notes?"} fontSize={"h2"}>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque efficitur leo a nisi porttitor, at convallis dolor mattis. Aenean  et laoreet eros, non blandit tellus. Fusce vel sagittis turpis, vel commodo eros. Curabitur mattis aliquet erat, vitae pulvinar urna facilisis ut.
                    </BoxSection>

                    <BoxSection title={"What Will I Learn?"} fontSize={"h2"}>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque efficitur leo a nisi porttitor, at convallis dolor mattis. Aenean  et laoreet eros, non blandit tellus. Fusce vel sagittis turpis, vel commodo eros.
                    </BoxSection>

                    <BoxSection title={"How Does It Work?"} fontSize={"h2"}>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque efficitur leo a nisi porttitor, at convallis dolor mattis. Aenean  et laoreet eros, non blandit tellus. Fusce vel sagittis turpis, vel commodo eros. Curabitur mattis aliquet erat, vitae pulvinar urna facilisis ut. Nullam efficitur varius est at tincidunt.
                    </BoxSection>
